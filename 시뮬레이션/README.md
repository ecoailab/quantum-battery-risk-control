...
The curated canonical package is public at <https://github.com/ecoailab/quantum-battery-risk-control>. Release `v1.0.0` and its commit SHA identify the archived submission snapshot.
