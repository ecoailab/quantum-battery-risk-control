...
The curated code, canonical artifacts, tests, and manuscript sources are publicly available at \url{https://github.com/ecoailab/quantum-battery-risk-control}.  Release \texttt{v1.0.0} and its commit SHA identify the submission snapshot.
